...
The time complexity of BFS is <code>O(&#124;V&#124;+&#124;E&#124;)</code> , where |V| is the number of vertices and |E| is the number of edges in the graph. This is because each vertex and edge is visited at most once.
